...
export const createApp = ({ settings, config, locale }) => {
  ...
  const app = new WishlistApp({
    ...
    dependencies: [
      ...
      "//www.chintiandparker.com/cdn/shop/t/308/assets/wishlist-king-custom.css?v=63816522155686180531726231719",
      "//www.chintiandparker.com/cdn/shop/t/308/assets/wishlist-king-components.js?v=67192780879355402051726231722",
    ],
  });
